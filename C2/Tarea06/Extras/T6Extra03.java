...
public class T6Extra03 {
    public static void main(String[] args) {
        ...
        String palabra = JOptionPane
                .showInputDialog("Ingrese la palabra que comprobará que no tenga abc antes o atrás: ");
        ...
        if (principioofinal) {
            JOptionPane.showMessageDialog(null,
                    "La palabra indicada contiene <abc> al principio o al final:" + palabra);
        } else if (contieneabc) {
            JOptionPane.showMessageDialog(null,
                    "La palabra indicada contiene <abc> en mitad de la palabra: " + palabra);
        } else {
