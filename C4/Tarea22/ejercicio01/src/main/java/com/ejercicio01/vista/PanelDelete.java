...
public class PanelDelete extends JFrame {
    ...
    public PanelDelete() {
        ...
        String[] labels = { "DELETE FROM: ", "WHERE: ", "ORDER BY: ", "LIMIT: " };
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (JTextField textField : textFields) {
                    ...
                    if (!valor.isEmpty()) {
                        switch (i) {
                            case 0:
                                queryStrBuil1.append("DELETE FROM " + valor);
                ...
                queryDelete = queryStrBuil1.toString();
